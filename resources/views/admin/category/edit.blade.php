	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="box">
				...
				{!! Form::model($category, array('method' => 'put', 'route' => array('admin.category.update', $category->iCategoryId), 'class' => 'form', 'files'=>true)) !!}
				{!! Form::hidden('iCategoryId', $category->iCategoryId) !!}
				<div class="box-body">
