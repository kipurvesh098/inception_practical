    ...
    */
    ...
    'custom' => [
        ...
        'vPassword' => [
            ...
            'min' => 'The password should be more than 6 characters long.',
        ],
        'vConfirmPassword' => [
        ...
        'vImage' => [
            ...
            'max' => 'The image must be :size kilobytes.',
        ...
        'vSlug' => [
            ...
            'unique'    => 'The promotion code has already been taken.',
        ],
        'dcAmount' => [
            'required'  => 'The amount | percentage field is required.',
            'numeric'   => 'The amount | percentage must be a number.',
        ],
        'vTitle' => [
